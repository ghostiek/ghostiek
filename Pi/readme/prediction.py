...
def moving_average_prediction(df: pd.DataFrame, days: int):
    if days < 1:
        raise ValueError("Days parameter needs to be greater than 0")
...
if __name__ == "__main__":
    ...
    result = moving_average_prediction(data, 1)
    print(result)
